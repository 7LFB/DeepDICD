...
# based on hvdTrain3.py
# train Domain Discriminator vs train Generator 
# 3 : 1
...
def main():
    ...
    with tf.control_dependencies([centroid_update_ops]):
        ...
        # different iter for generator and discriminator
    ...
    for step in range(start_steps, num_steps):
        ...
        # Chong: train G and D with different speed
        for _ in range(EVERY_DISCRIMINATOR):
