# 1. utilizing moving centroid loss in
# another way-- add weights sum
# build_weights_centroid_based_losses
...
class DeepDICDModel(object):
    ...
    def build_losses(self, alpha1, alpha2, alpha3=10):
    ...
    def build_laplacian_regularization(self,centers_,features_,pred_):
        ...
        gt_=tf.one_hot(tf.cast(tf.linspace(0.,30.,self.params.num_classes),tf.int64),self.params.num_classes)
